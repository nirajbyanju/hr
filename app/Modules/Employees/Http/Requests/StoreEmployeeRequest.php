...
class StoreEmployeeRequest extends FormRequest
{
    ...
    {
        return [
            'user_id' => ['nullable', 'integer', 'exists:users,id', Rule::unique(Employee::class, 'user_id')],
            'employee_code' => ['nullable', 'string', 'max:50', Rule::unique(Employee::class, 'employee_code')],
            ...
            'work_email' => ['nullable', 'email', 'max:255', Rule::unique(Employee::class, 'work_email')],
